...
- `pnpm run test`: pass (42 passed, 2 skipped)
- `scripts/ae/phase2-run.sh`: pass
  - `artifacts/runs/20260216T064125Z/phase2-summary.json`
  - `artifacts/runs/20260216T064125Z/acceptance-vitest.json`
  - `artifacts/runs/20260216T064125Z/acceptance-lgacc-summary.json`
